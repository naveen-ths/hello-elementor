...
get_header();
?>
<div class="database-products-container">

  <div class="page-content">
    <?php the_content(); ?>
  </div>

  <div id="database-products-grid" class="database-grid elementor-container">
    <!-- Products will be loaded here -->
  </div>

  <div class="load-more-container" style="text-align: center;">
    <button id="load-more-products" class="load-more-btn"
      style="background: #e74c3c; color: white; padding: 12px 30px; border: none; border-radius: 5px; font-size: 16px; cursor: pointer; display: none;">
...
<div class="database-search-container" style="max-width: 1200px; margin: 50px auto 0; padding: 20px;">
  ...
  <div class="search-box-container" style="margin-bottom: 30px;">
    <div class="search-input-wrapper" style="display: flex; max-width: 800px; margin: 0 auto;">
      ...
      <button id="database-search-btn"
        style="padding: 15px 30px; background: #333; color: white; border: none; font-size: 16px; cursor: pointer;">
        Search
      </button>
    </div>
